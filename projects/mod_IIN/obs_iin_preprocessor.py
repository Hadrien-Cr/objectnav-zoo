...
class ObsIINPreprocessor:
    ...
    def __init__(self, config: DictConfig, device: torch.device) -> None:
        ...
        self.preprojection_kp_dilation = config.ENVIRONMENT.preprojection_kp_dilation
        self.match_projection_threshold = config.AGENT.SUPERGLUE.match_projection_threshold
