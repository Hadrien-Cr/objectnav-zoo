...
def get_config(
    ...
    assert rgb_sensor.height >= frame_height and rgb_sensor.height % frame_height == 0, (rgb_sensor.height, frame_height)
    ...
    assert rgb_sensor.width >= frame_width and rgb_sensor.width % frame_width == 0, (rgb_sensor.width, frame_width)
