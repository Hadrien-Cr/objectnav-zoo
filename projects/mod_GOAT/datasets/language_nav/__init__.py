...
def _try_register_languagenavdatasetv1():
    try:
        from habitat.datasets.language_nav.language_nav_dataset import (  # noqa: F401
            LanguageNavDatasetV1,
        )
        ...
        class LanguageNavDatasetImportError(Dataset):
